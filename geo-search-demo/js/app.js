$(document).ready(function() {
  ...
  // Map initialization
  var map = new google.maps.Map($map.get(0), { streetViewControl: true, center: {lat: 45.506521, lng: -73.653123}, mapTypeControl: false, zoom: 4, minZoom: 3, maxZoom: 12, styles: [{ stylers: [{ hue: "#3596D2" }] } ] });
