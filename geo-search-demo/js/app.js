$(document).ready(function() {
  ...
  // Map initialization
  var map = new google.maps.Map($map.get(0), { center: {lat: 45.5065, lng: -73.6531}, streetViewControl: true, mapTypeControl: false, zoom: 13, minZoom: 3, maxZoom: 20, styles: [{ stylers: [{ hue: "#3596D2" }] } ] });
